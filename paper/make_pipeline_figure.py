...
# Split
box(3.0, 9.0, 4.0, 0.95, "Plane / bit-field split\n[ sign | exponent | mantissa ]", CORE)
# Two planes
box(0.5, 7.0, 4.0, 1.1, "Exponent / sign plane\n(low entropy)\n→ rANS or zstd", EXP)
box(5.5, 7.0, 4.0, 1.1, "Mantissa plane\n(noise-like)\n→ store or zstd", MAN)
# Whole-tensor matching
box(2.5, 5.0, 5.0, 1.05, "Whole-tensor long-distance matching\n(dedup tied / repeated weights)", CORE)
# Best-of
box(2.5, 3.2, 5.0, 1.05, "Best-of selection\n(keep smallest; never worse than zstd)", CORE)
# Output container
box(2.0, 1.2, 6.0, 1.1,
...
ax.text(5.0, 0.5,
        ...
        ha="center", va="center", fontsize=8.5, style="italic", color="#55606e")
